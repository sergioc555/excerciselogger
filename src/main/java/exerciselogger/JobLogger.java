...
public class JobLogger {
	...
	private static final EnumMap<TypesLogs, String> DESCRIPTION_TYPES = new EnumMap<TypesLogs, String>(
			TypesLogs.class) {
		{
			put(TypesLogs.TYPE_MESSAGE, "[MESSAGE]");
			put(TypesLogs.TYPE_WARNING, "[WARNING]");
			put(TypesLogs.TYPE_ERROR, "[ERROR  ]");
		};
	};
	...
	public void init() throws MyLogException
	{
		...
		if (this.options.isOptionLogToFile()) {
			try {
				...
				this.fh = new FileHandler(dbParams.get("logFile"), true);
